package com.shrija.ai.agent.report;
 ...
 * the full set of department agents), but calling {@link #build()} fails loudly until the Report
 ...
 * data access for Report domain operations), and any sub-agents it delegates to, then replace the
...
public class ReportAgentFactory implements AgentFactory {
  ...
  public BaseAgent build() {
    throw new UnsupportedOperationException(
        "Report Agent is not yet implemented. See ReportAgentFactory for scope.");
  }
}
