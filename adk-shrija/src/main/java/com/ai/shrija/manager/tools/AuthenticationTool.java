...
public class AuthenticationTool {
  ...
  public static Map<String, Object> authenticate(String employeeId, String password) {

    Employee employee = employeeDao.authenticate(employeeId, password);

    if (employee == null) {

      return Map.of("authenticated", false, "message", "Invalid Employee ID or Password");
    }
