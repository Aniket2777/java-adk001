...
import com.shrija.orchestrator.a2a.BudgetAgentClient;
import com.shrija.orchestrator.a2a.CtoAgentClient;
 ...
 * character from the "Authenticated actor: ..." context line the ConversationService injects
 * (never invent them) -- and this class (plain Java, not the LLM) is what actually assembles the
 * trusted context line forwarded to the downstream agent. This mirrors how CheckInTool /
 * ApproveLeaveTool etc. already require requesterEmployeeId/requesterRole as explicit,
 * literally-copied arguments rather than trusting free text.
 */
@Component
public class DelegationTools {
  ...
  private final CtoAgentClient ctoAgentClient;
  ...
  public DelegationTools(
      ...
      BudgetAgentClient budgetAgentClient,
      CtoAgentClient ctoAgentClient) {
    ...
    this.ctoAgentClient = ctoAgentClient;
  }
  ...
  public Map<String, Object> delegateToBudgetAgent(
      String requesterEmployeeId,
      String requesterRole,
      String targetEmployeeId,
      String currentDate,
  ...
  public Map<String, Object> delegateToCtoAgent(
      String requesterEmployeeId,
      String requesterRole,
      String targetEmployeeId,
      String currentDate,
  ...
  private Map<String, Object> runDelegation(
    ...
    try {
      ...
      return Map.of(
          "agent", targetAgentName, "error", targetAgentName + " is unavailable: " + ex.getMessage());
    }
  }
}
