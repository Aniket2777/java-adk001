...
/**
 * The Orchestrator Agent uses no MCP server of its own (per the responsibility table: "Uses MCP:
 * No (indirectly through agents)") — it only needs a model and the A2A URL of every downstream
 * agent it may route to.
 */
@Validated
