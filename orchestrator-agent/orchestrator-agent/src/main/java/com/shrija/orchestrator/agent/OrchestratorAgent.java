        ...
        LlmAgent.builder()
            ...
            .description(
                "Top-level HRMS orchestrator. Performs semantic intent analysis and routes "
                    + "requests to the Employee, Attendance, Payroll, HR, Leave, Manager, Budget, "
                    + "and CTO agents over A2A. Owns no MCP tools of its own.")
            ...
            .tools(
                ImmutableList.of(
                    ...
                    FunctionTool.create(delegationTools, "delegateToBudgetAgent"),
                    FunctionTool.create(delegationTools, "delegateToCtoAgent")))
            .build();
  }
